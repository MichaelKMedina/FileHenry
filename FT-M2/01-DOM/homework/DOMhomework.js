...
// Tu código acá:
var spamBy = document.querySelector("#createdBy")
spamBy.innerHTML = 'Aplicación creada por Michael'
...
function buildToDo(todo, index) {
  ...
  var toDoText = document.createElement('label');
...
var arrIterar = buildToDos(toDoItems);
arrIterar.forEach(element => { toDoContainer.appendChild(element)});
}
...
function addToDo() {
  ...
  if(value){
    let nTo = new ToDo(value);
    var input = document.getElementById('toDoInput');
    toDoItems.push(nTo);
  }
  else{
    alert('Por favor ingresar caracteres')
  }
  input.value = '';
  displayToDos();
}
...
// Tu código acá:
let evento = document.getElementById('addButton');
