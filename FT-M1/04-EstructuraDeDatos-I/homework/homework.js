...
como n!) es el producto de n por todos los números naturales menores que él y mayores a 0. 
Ejemplo: 5! = 5 * 4 * 3 * 2 * 1
...
let nroF = nFibonacci(n - 1) + nFibonacci(n - 2)
